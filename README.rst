...
La balise ``espace deux-points`` donnera un rendu de votre espace et vos deux-points
...
Non ! il n'insère pas magiquement une espace insécable donc ce n'est toujours pas
